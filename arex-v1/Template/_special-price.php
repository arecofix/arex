...
<section id="special-price">
    <div class="container">
        ...
        <div class="grid">
            <?php
            $count = 0; // Contador de productos mostrados
            foreach ($product_shuffle as $item) {
                if ($count < 10) { // Muestra solo los primeros 10 productos
                    ?>
                    ...
                    <?php
                    $count++; // Incrementa el contador después de mostrar un producto
                } else {
                    break; // Rompe el bucle después de mostrar 10 productos
                }
            }
            ?>
        </div>
