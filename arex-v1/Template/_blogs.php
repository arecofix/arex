...
<section id="blogs">
    <div class="container py-4">
        <h4 class="font-rubik font-size-20">Ultimas Novedades en Tecnologia</h4>
        <hr>

        <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                <h5 class="card-title font-size-16">Próximos Celulares</h5>
                    <img src="./assets/blog/blog1.jpg" alt="cart image" class="card-img-top">
                    <p class="card-text font-size-14 text-black-50 py-1">Explora las últimas novedades en repuestos y accesorios para celulares. Descubre productos de alta calidad para mantener tu dispositivo siempre en funcionamiento.</p>
